...
@Getter
public class OnOrderItemCreatedEvent extends ApplicationEvent {
    private final BarOrderItem barOrderItem;
    private final BarOrder barOrder;
    private final BarTable barTable;

    public OnOrderItemCreatedEvent(Object source, BarOrderItem barOrderItem, BarOrder barOrder, BarTable barTable) {
        super(source);
